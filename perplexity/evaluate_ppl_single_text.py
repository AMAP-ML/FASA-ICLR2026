...
def main(model_name,prefilling_len,dataset_name,decoding_len,limit,min_k,max_k,threshold_ratio,reverse):
    if args.compression_methods in ["snapkv", "streamingllm"]:
        ...
        records = constructe_adaptive_selection(model_name,args.budget,args.threshold_ratio,args.min_k,args.max_k,dataset_name=f"{args.cal_dataset}_{args.prefilling_len}_256")
